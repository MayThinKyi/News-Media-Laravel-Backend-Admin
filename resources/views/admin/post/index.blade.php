...
<div class="card rounded shadow-sm py-3 px-4">
    <form action="{{route('admin#createPost')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="my-2">
            ...
            <input type="text" value="{{old('postName')}}" name="postName" placeholder="Enter Post Title..." class="form-control @error('postName') is-invalid @enderror">
             @error('postName')
        ...
        <div class="mt-3">
            ...
            <textarea  name="postDescription" placeholder="Enter Post Description..." cols="30" rows="10" class="form-control @error('postDescription') is-invalid @enderror">{{old('postDescription')}}</textarea>
        ...
        <div class="text-center">
            <button type="submit" class="btn btn-dark text-white mt-4">Create Post</button>
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                 <form action="{{route('admin#searchPost')}}" method="get">
                    @csrf
